...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer:  
    Hello! My name is **Jeffrey Kinard** and I am a senior here at Iowa State University. I am majoring in  *Computer Engineering* with a minor in Data Science. I am originally from Fort Worth, Texas, but decided to go out of state for a new adventure and to save on cost!
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer:  
    A business analyst is responsible for improving business by looking at business data, analyzing the data, and coming up with solutions to improve the focus areas of the data.  
      [Business Analyst Info](https://www.cio.com/article/2436638/project-management-what-do-business-analysts-actually-do-for-software-implementation-projects.html)  
...
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.
    ...
    Answer:  
    I think using data science in the medical field is very interesting. Especially in the midst of a pandemic, gathering and analyzing medical data is very intersting to me.
